"""BTCUSDT Liquidity Heatmap Dashboard (version 16)
    ...
    [
        ...
        html.Div(
            [
                ...
                dcc.Slider(id="smooth", min=0, max=2, step=1, value=0, marks={0: "no smooth", 1: "1", 2: "2"}, tooltip={"placement": "bottom"}, style={"width": "200px", "marginLeft": "10px"}),
                dcc.RadioItems(
                    id="zoom",
